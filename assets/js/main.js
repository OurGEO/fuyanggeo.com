...
document.addEventListener('DOMContentLoaded', function () {
  var menuBtn = document.getElementById('menuBtn') || document.querySelector('[data-menu]');
  var navLinks = document.getElementById('navLinks') || document.querySelector('[data-nav]');
  ...
  var faqButtons = document.querySelectorAll('[data-faq-question]');
